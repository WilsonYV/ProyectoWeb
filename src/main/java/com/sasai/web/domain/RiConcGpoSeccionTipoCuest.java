...
@Entity
@Table(name = "ri_conc_gpo_seccion_tipo_cuest")
public class RiConcGpoSeccionTipoCuest extends AbstractAuditingEntity implements Serializable {
    ...
    @Column(name = "id_concepto_cuest", nullable = true)
    ...
    @Column(name = "secuencia_presentacion_conc", nullable = false)
    private Long SecuenciaPresentacionConc;
    ...
    @Column(name = "b_campo_para_baja_registro", nullable = true)
    private String BCampoParaBajaRegistro;
    ...
    public Long getSecuenciaPresentacionConc() {
        return SecuenciaPresentacionConc;
    }

    public void setSecuenciaPresentacionConc(Long secuenciaPresentacionConc) {
        SecuenciaPresentacionConc = secuenciaPresentacionConc;
    }
    ...
    public String getBCampoParaBajaRegistro() {
        return BCampoParaBajaRegistro;
    }

    public void setBCampoParaBajaRegistro(String bCampoParaBajaRegistro) {
        BCampoParaBajaRegistro = bCampoParaBajaRegistro;
    }
    ...
    public String toString() {
        return (
            "RiConcGpoSeccionTipoCuest [IdTipoCuest=" +
            IdTipoCuest +
            ", IdSeccionTipoCuest=" +
            IdSeccionTipoCuest +
            ", IdGrupoSeccionCuest=" +
            ...
            IdReglaValidacionEditable +
            ", BCampoParaBajaRegistro=" +
            BCampoParaBajaRegistro +
            ", ExpresionRegularValid=" +
            ", FIniVigencia=" +
            FIniVigencia +
            ", FFinVigencia=" +
            FFinVigencia +
